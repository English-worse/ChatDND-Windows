...
- 当前发布包尚未进行代码签名，Windows SmartScreen 可能提示未知发布者；请只从本仓库 Release 页面下载。

## 许可证

本项目采用 **PolyForm Noncommercial License 1.0.0**。

- 个人学习、研究、实验、娱乐和业余项目可免费使用。
- 教育机构、公共研究机构、公益组织、公共安全、公共卫生和政府机构等非商业用途可使用。
- 商业用途不被该许可证允许，必须单独取得商业授权。
- 这是 **source-available** 许可证，不是 OSI 定义下的开源许可证。
...
如需商业使用、企业内部生产使用或商业分发，请通过仓库 Issue 或作者 GitHub 主页联系作者取得单独授权。
